...
class TextFieldValidator
{
    ...
    func validateTouristFields(_ tourists: [TouristModel], completion: @escaping (Int)->())
    {
    ...
    func validatePhoneAndEmailFields(_ phone: String, _ email: String, comletion: @escaping (Int)->()) -> Bool
    {
